...
exports.commands = {
	...
	credits: function (target, room, user) {
		let popup = "|html|" + "<font size=5 color=#0066ff><u>" + serverName + " Credits</b></u></font><br />" +
			...
			"- " + Server.nameColor('ArcRea', true) + " (Owner, Policy + Technical Admin, Development)<br />" +
			"- " + Server.nameColor('CodingHero', true) + " (Owner, Technical Admin, Development)<br />" +
			"<br />" +
			"<u><b>Contributors:</b></u><br />" +
			"- " + Server.nameColor('Zruler_King', true) + " (SgGame Leader, Regular User)<br />" +
			"- " + Server.nameColor('ReaperXP', true) + " (Global Leader, Regular User)<br />" +
			"- " + Server.nameColor('Suprer', true) + " (Global Admin)<br/>" +
