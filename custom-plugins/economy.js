...
exports.commands = {
	...
	gsubs: 'givesubs', //You can change "gs" and "giveBucks" to your currency name for an alias that applies to your currency Example: AwesomeBucks could be "ga" and "giveawesomebucks"
	giveSubscribers: 'givesubs',
	gSubs: 'givesubs',
	givesubs: function (target, room, user, connection, cmd) {
